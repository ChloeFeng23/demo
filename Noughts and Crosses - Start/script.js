var currentPlayer = 1;//current player 1 r 2
var plays = 0; //counts the number of players or turns taken
...
function announceWin(winner){
	document.querySelector("#popup").innerHTML = '<img src="image/183568.png" alt="x button" id="x"><h1>' + winner + ' Wins!</h1>';
	document.querySelector("#x").addEventListener("click",hidePopup);
	document.querySelector("#container").style.display = "flex";
}

function annunceCatsGame(){
	document.querySelector("#container").style.display = "flex";
}
